...
const words = {
  en: {
    action: [
      ...
      "make everyone laugh",
      "cause unexpected chaos",
      "make a new friend",
      "forget where they parked",
    ],
    wildAction: [
      "challenge a stranger to a drinking game",
      "end up on stage",
      "start a conga line",
      "convince the DJ to play their song",
      "get everyone dancing",
      "make a bold move on someone",
    ],
    flirtyAction: [
      "flirt with someone they just met",
  ...
  sv: {
    action: [
      ...
      "orsaka oväntad kaos",
      "göra en ny vän",
      "glömma var de parkerat",
    ],
    wildAction: [
      "utmana en främling till ett drinkspel",
      "hamna på scen",
      "starta en coganslinga",
      "övertala DJ:n att spela deras låt",
      "få alla att dansa",
      "göra ett djärvt drag på någon",
    ],
    flirtyAction: [
      "flirta med någon de precis träffat",
      "få någons nummer",
      "blinka åt en främling",
      "glida in i någons DMs",
...
function fillTemplate(template, data) {
  ...
  result = result.replace(
    /{event}/g,
    data.event || (lang === "sv" ? "evenemanget" : "the event"),
  );
  result = result.replace(
    /{place}/g,
    data.place || (lang === "sv" ? "platsen" : "the place"),
  );
  result = result.replace(
    /{group}/g,
    data.group || (lang === "sv" ? "gruppen" : "the group"),
  );
  result = result.replace(
    /{vibe}/g,
    data.vibe || (lang === "sv" ? "stämningen" : "the vibe"),
  );
