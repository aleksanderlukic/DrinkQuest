    ...
    >
      ...
      <div className="p-5">
        ...
        <div className="flex items-start justify-between mb-3">
          <div className={`w-12 h-12 rounded-xl flex items-center justify-center text-2xl bg-gradient-to-br ${game.gradient} bg-opacity-10`}>
            {game.emoji}
          </div>
        ...
        <p className={`text-xs leading-relaxed mb-4 line-clamp-2 ${isDark ? 'text-slate-400' : 'text-slate-500'}`}>
          {t(game.shortDescKey)}
        </p>
