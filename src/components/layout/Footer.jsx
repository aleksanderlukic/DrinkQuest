...
export default function Footer() {
  ...
  const gameLinks = [
    ...
    { path: '/games/never-have-i-ever', label: t('games.neverHaveIEver.title') },
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 mb-10">
          ...
          <div>
            <Link to="/" className="flex items-center gap-2 mb-3">
              ...
              <span className={`font-black text-xl ${isDark ? 'text-white' : 'text-slate-900'}`}>
          ...
          {/* Play links */}
          <div>
            <h4 className={`font-semibold text-sm uppercase tracking-wider mb-4 ${isDark ? 'text-slate-400' : 'text-slate-500'}`}>
        ...
        {/* Bottom */}
        <div className={`pt-8 border-t flex flex-col sm:flex-row items-center justify-between gap-4 ${isDark ? 'border-white/5' : 'border-slate-200'}`}>
