      ...
      {open && (
        <>
          ...
          >
            {/* Header */}
            <div
              className={`flex items-center justify-between p-5 border-b ${isDark ? "border-white/10" : "border-slate-100"}`}
            >
              <span
            ...
            {/* Footer controls */}
            <div
              className={`p-4 border-t flex items-center gap-3 ${isDark ? "border-white/10" : "border-slate-100"}`}
            >
              <LanguageSwitcher />
              <ThemeToggle />
            </div>
