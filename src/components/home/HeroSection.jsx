...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      {/* Floating emojis */}
      <div className="absolute top-1/4 left-8 text-4xl animate-float opacity-20 select-none pointer-events-none">
        🎉
      </div>
      <div
        className="absolute top-1/3 right-10 text-3xl animate-float opacity-20 select-none pointer-events-none"
        style={{ animationDelay: "0.8s" }}
      >
        🥂
      </div>
      <div
        className="absolute bottom-1/3 left-16 text-2xl animate-float opacity-20 select-none pointer-events-none"
        style={{ animationDelay: "1.4s" }}
      >
        🎲
      </div>
      <div
        className="absolute bottom-1/4 right-12 text-3xl animate-float opacity-20 select-none pointer-events-none"
